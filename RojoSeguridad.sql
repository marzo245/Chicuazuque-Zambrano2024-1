...
GRANT SELECT ON ClasificacionEquipos to USUARIOS;
...
GRANT SELECT ON ClasificacionEquipos to ADMINISTRADORES;
...
GRANT SELECT ON ClasificacionEquipos to GERENTE_EQUIPOS;
